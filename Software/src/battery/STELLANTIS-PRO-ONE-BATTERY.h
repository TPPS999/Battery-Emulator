...
class StellantisProOneBattery : public UdsCanBattery {
  ...
  */
  ...
  //0x359 bytes 0-1. Only non-zero once the car asks for a charge session on 0x2A5. About 22 kW at the
  //pack voltage; it is never observed to constrain the current in any capture.
