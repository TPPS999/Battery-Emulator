...
String StellantisProOneBattery::get_uds_info_html() {
  ...
  content << "<h4>BMS HW version number: " << pid_hw_version_num << "</h4>"
              ...
              "<h4>Charge limit 0x285, short/long/long: " << charge_limit_dA[0] / 10 << " / "
                                                            << charge_limit_dA[1] / 10 << " / "
                                                            << charge_limit_dA[2] / 10 << " A</h4>"
              "<h4>Discharge limit 0x281, short/long/long: " << discharge_limit_dA[0] / 10 << " / "
                                                              << discharge_limit_dA[1] / 10 << " / "
                                                              << discharge_limit_dA[2] / 10 << " A</h4>"
              "<h4>OBC charge limit 0x359: " << obc_charge_limit_dA / 10 << " A</h4>"
              "<h4>Reported to the inverter: " << datalayer.battery.status.max_charge_power_W << " W charge / "
                                               << datalayer.battery.status.max_discharge_power_W
                                               << " W discharge</h4>"
              "<h4>Charge taper: mandatory (limits above are a hypothesis)</h4>"
